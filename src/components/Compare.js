...
import { Starbucks, Hollys, Ediya } from "img";
              ...
              <div className="container">
                <div>
                  <div className="categories__slider owl-carousel">
                    <Slider {...settings}>
                      <div
                        onClick={() => alert("Starbucks!")}
                        className="categories__item__whole"
                      >
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="product__item">
                  <div
                    ...
                    style={{ backgroundImage: `url(${teamA})` }}
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="product__item">
                  <div
                    className="product__item__pic set-bg"
                    style={{
                      background: `url('http://paikdabang.com/wp-content/uploads/2018/05/03_앗메리카노_HOT.jpg')`,
